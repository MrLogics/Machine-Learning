...
OBESITY['HEALTHY'] = fuzz.trimf(OBESITY.universe, [0, 0, 50])
OBESITY['OVERWEIGHT'] = fuzz.trimf(OBESITY.universe, [0, 50, 100])
OBESITY['OBESE'] = fuzz.trimf(OBESITY.universe, [50, 50, 100])
